...
const store = createStore({
  state() {
    return {
      itemsTartalet: [
        { id: 1, nameKey: 'cake.name-1', des: 'this des cake 1', images: [{ src: 'https://picsum.photos/id/1/200/200/'}, { src: 'https://picsum.photos/id/10/200/200/'}] },
        { id: 2, nameKey: 'cake.name-2', des: 'this des cake 2', images: [{ src: 'https://picsum.photos/id/11/200/200/'}, { src: 'https://picsum.photos/id/15/200/200/'}] },
      ],
      itemsCake: [
